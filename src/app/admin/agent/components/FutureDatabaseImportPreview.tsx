...
export function FutureDatabaseImportPreview({
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 dark:border-[#27272a] bg-white dark:bg-[#111113] overflow-hidden">
      ...
      {expanded && (
        <div className="border-t border-zinc-200 dark:border-[#1c1c1e] px-5 py-4 space-y-4">
          {items.length === 0 ? (
            ...
            <>
                  ...
                  <div
                    ...
                    className={`rounded-xl border px-3 py-2.5 text-[11px] space-y-1 ${
                      item.warnings.length > 0
                        ...
                        : 'border-zinc-200 dark:border-[#1c1c1e] bg-[#0d0d0f]'
                    }`}
                  >
                    <div className="flex items-center justify-between gap-2">
                      <span className="text-zinc-700 dark:text-[#a1a1aa] font-medium truncate">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="text-[11px] text-zinc-700 dark:text-[#71717a] hover:text-zinc-900 dark:text-[#f5f5f5] border border-zinc-200 dark:border-[#27272a] hover:border-[#3f3f46] rounded-full px-3 py-1.5 transition-colors"
                >
