...
export function AboutPanel() {
  ...
  return (
    <div className="rounded-2xl border border-[#1c1c1e] bg-[#0d0d0f] overflow-hidden">
      ...
      {open && (
        <div className="px-5 pb-5 border-t border-[#1c1c1e] space-y-3 pt-4">
          ...
          <p className="text-xs text-[#71717a]">
            <strong className="text-[#a1a1aa]">What it does:</strong> Routes the enquiry, scores
            the lead, extracts context, drafts a reply, and flags follow-up actions. All output is
            for internal review only.
          </p>
          <p className="text-xs text-[#71717a]">
            <strong className="text-[#a1a1aa]">What it does not do:</strong> Send emails, send
            WhatsApps, write to a database, create calendar events, or take any production action.
            Every run is a draft for human review.
          </p>
          <p className="text-xs text-[#71717a]">
            <strong className="text-[#a1a1aa]">Local history:</strong> Analyses are stored in
