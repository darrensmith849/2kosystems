        ...
        <SectionHeader
          ...
          subtitle={
            <>
              ...
              <span className="ml-2 text-zinc-700 dark:text-[#71717a]">{r.kind}</span>
            </>
          }
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="space-y-4">
            <AdminCard title="What needs confirming">
              <p className="text-xs text-zinc-700 dark:text-[#a1a1aa] leading-relaxed">{r.notes ?? 'Verify with the provider before relying on the snapshot date.'}</p>
            </AdminCard>
