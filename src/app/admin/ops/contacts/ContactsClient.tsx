        ...
        <ul className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          {CONTACT_ROLES_REQUIRED.map((role) => {
            ...
            return (
              <li
                key={role}
                className="flex items-center gap-2 rounded-xl border border-zinc-200 dark:border-[#1c1c1e] bg-zinc-50 dark:bg-[#0e0e10] px-3 py-2"
              >
                <span
        ...
        {!showForm && (
          <div className="mb-4 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-full border border-zinc-200 dark:border-[#27272a] bg-zinc-50 dark:bg-[#0e0e10] px-3 py-1.5 text-xs text-zinc-800 dark:text-[#e4e4e7] hover:border-emerald-400/40 hover:text-emerald-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <IconDownload />
              Export JSON
            </button>
            ...
            {drafts.map((d) => (
              ...
              >
                <div className="flex flex-wrap items-center gap-2 mb-1.5">
                  <p className="text-sm font-medium text-zinc-900 dark:text-[#f5f5f5]">
                    {d.name || '(unnamed)'}
                  </p>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        ...
        <Field label="Role">
          <select
            ...
            className="w-full rounded-md border border-zinc-200 dark:border-[#27272a] bg-zinc-50 dark:bg-[#0e0e10] px-2.5 py-1.5 text-xs text-zinc-900 dark:text-[#f5f5f5] focus:border-emerald-400/40 focus:outline-none"
          >
