    ...
    <aside className="hidden lg:flex lg:flex-col w-56 shrink-0 border-r border-[#1c1c1e] bg-[#0a0a0b]/95 backdrop-blur-sm sticky top-0 h-screen overflow-y-auto">
      <div className="flex flex-col h-full">
        <div className="px-4 pt-5 pb-4 border-b border-[#1c1c1e]">
          <p className="text-[10px] font-mono uppercase tracking-[0.22em] text-[#52525b]">
            2KO Systems
          </p>
          <p className="mt-1 text-sm font-semibold text-[#f5f5f5]">Ops Dashboard</p>
        </div>

        <div className="px-4 py-3 border-b border-[#1c1c1e] flex items-center gap-1">
        ...
        <nav className="flex-1 px-2 py-4 space-y-5 overflow-y-auto">
          {OPS_NAV_GROUPS.map((group) => (
            <div key={group.title}>
              <p className="px-3 mb-1.5 text-[10px] font-mono uppercase tracking-[0.2em] text-[#52525b]">
                {group.title}
              </p>
                      ...
                      <Link
                        ...
                        className={`flex items-center px-3 py-1.5 text-[12px] font-mono tracking-wide border-l-2 transition-colors ${
                          active
                            ...
                            : 'text-[#71717a] hover:text-[#f5f5f5] border-transparent hover:border-[#27272a]'
                        }`}
                      >
                        {item.label}
                      </Link>
        ...
        <div className="px-4 py-4 border-t border-[#1c1c1e] space-y-2">
          <div className="flex flex-col gap-1">
            ...
            <button
              ...
              className="text-[11px] font-mono text-emerald-300 hover:text-emerald-200 border border-emerald-400/30 rounded-full px-3 py-1 text-left truncate"
