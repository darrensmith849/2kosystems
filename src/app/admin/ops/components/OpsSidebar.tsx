          ...
          {OPS_NAV_GROUPS.map((group, idx) => {
            ...
            return (
              <div
                ...
                className={
                  isConsoleSwitcher
                    ? 'pb-4 border-b border-zinc-200 dark:border-white/[0.06]'
                    : undefined
                }
              >
                {isCollapsible ? (
        ...
        <div className="shrink-0 px-4 py-4 border-t border-zinc-200 dark:border-white/[0.06] space-y-2 bg-white dark:bg-[#0a0a0b]/95 transition-colors">
          <div className="flex flex-col gap-1">
            ...
            <button
              ...
              className="text-xs text-zinc-900 dark:text-zinc-100 hover:text-zinc-900 dark:hover:text-white border border-zinc-300 dark:border-white/[0.08] hover:border-zinc-400 dark:hover:border-white/[0.12] rounded-md px-2.5 py-1 text-left bg-zinc-50 dark:bg-white/[0.02]"
              title={operatorSlug}
              aria-label="Switch user"
            >
              <span className="block text-[11px] text-zinc-600 dark:text-zinc-400">Switch user</span>
          ...
          <button
            ...
            className="w-full text-xs text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 border border-zinc-200 dark:border-white/[0.06] hover:border-zinc-300 dark:hover:border-white/[0.08] rounded-md px-2.5 py-1"
          >
            Sign out
          </button>
        </div>
