...
export default async function ReportsPage() {
  ...
  return (
    <>
      ...
      <p className="mb-5 font-mono text-[11px] text-zinc-700 dark:text-[#71717a]">
        Generated <time dateTime={summary.generatedAt}>{formatTimestamp(summary.generatedAt)}</time>
        {' · '}source: <span className="text-zinc-700 dark:text-[#a1a1aa]">{summary.dataSource}</span>
      </p>
...
function CommercialReadiness() {
  ...
  return (
    <section className="mb-8">
      ...
      <p className="mb-4 text-xs text-zinc-700 dark:text-[#a1a1aa]">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <AdminCard title="Email linkage readiness">
          <div className="space-y-3">
            ...
            <div>
              <p className="mb-1.5 text-[10px] uppercase tracking-[0.18em] text-zinc-700 dark:text-[#71717a]">
        ...
        <ul className="mb-3 space-y-1">
          {card.rows.map((row, i) => (
            <li key={i} className="flex gap-2 text-[11px] text-zinc-800 dark:text-[#e4e4e7]">
              <span className="text-zinc-600 dark:text-[#52525b]">·</span>
              <span className="leading-relaxed">{row}</span>
            </li>
          ))}
        </ul>
      ) : (
        <p className="mb-3 text-[11px] text-zinc-700 dark:text-[#71717a]">Nothing flagged.</p>
      )}
      <Link
        href={card.href}
  ...
  return (
    <div className="mb-6">
      <AdminCard
        ...
        action={<span className="font-mono text-[10px] uppercase tracking-[0.15em] text-zinc-700 dark:text-[#71717a]">{total} tracked</span>}
      >
        {total === 0 ? (
          <p className="text-xs text-zinc-700 dark:text-[#71717a]">No renewals indexed.</p>
        ) : (
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4 lg:grid-cols-7">
            {rows.map((row) => (
              ...
              >
                <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-700 dark:text-[#71717a]">
    ...
    <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-2">
      <AdminCard title="Incidents by severity">
        <DataTable
          ...
          empty={<p className="text-xs text-zinc-700 dark:text-[#71717a]">No incidents indexed.</p>}
        />
      </AdminCard>
    ...
    <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-2">
      <AdminCard title="Decisions by risk">
        <DataTable
          ...
          empty={<p className="text-xs text-zinc-700 dark:text-[#71717a]">No decisions indexed.</p>}
        />
      </AdminCard>
    ...
    <div className="mb-6">
      <AdminCard title="Blocked-by breakdown">
        <DataTable
          ...
          empty={<p className="text-xs text-zinc-700 dark:text-[#71717a]">Nothing blocked right now.</p>}
        />
      </AdminCard>
    </div>
  );
      ...
      >
        <div className="flex flex-wrap items-baseline gap-4">
          <p className="text-2xl font-semibold text-zinc-900 dark:text-[#f5f5f5]">
            {a.ready}
            <span className="ml-1 text-sm font-normal text-zinc-700 dark:text-[#71717a]">/ {a.total} ready</span>
          </p>
          <p className="font-mono text-xs text-zinc-700 dark:text-[#a1a1aa]">{a.pending} pending</p>
    ...
    <div className="mb-6">
      ...
      >
        <div className="flex flex-wrap items-baseline gap-4">
          ...
          <p className="font-mono text-xs text-zinc-700 dark:text-[#71717a]">{i.total} import groups</p>
        </div>
      </AdminCard>
    </div>
  );
        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              key: 'division',
              header: 'Division',
              render: (r) => <span className="text-xs text-zinc-700 dark:text-[#a1a1aa]">{r.subtitle ?? '—'}</span>,
            },
            {
              key: 'assets',
              header: 'Assets',
          ...
          empty={<p className="text-xs text-zinc-700 dark:text-[#71717a]">No assets linked to clients.</p>}
        />
      </AdminCard>
    </div>
  );
    ...
    <div className="mb-6">
      <AdminCard title="Infrastructure footprint">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-700 dark:text-[#71717a]">Vercel by team</p>
            <DataTable
              rows={vercelByTeam}
              columns={[
              ...
              empty={<p className="text-xs text-zinc-700 dark:text-[#71717a]">No Vercel teams indexed.</p>}
            />
          </div>
          <div>
            <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-700 dark:text-[#71717a]">Vercel by state</p>
            <DataTable
              ...
              empty={<p className="text-xs text-zinc-700 dark:text-[#71717a]">No Vercel state data.</p>}
            />
          </div>
          <div>
            <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-700 dark:text-[#71717a]">Hetzner by role</p>
            <DataTable
              ...
              empty={<p className="text-xs text-zinc-700 dark:text-[#71717a]">No Hetzner servers indexed.</p>}
            />
          </div>
          <div>
            <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-700 dark:text-[#71717a]">Cloudflare</p>
        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              key: 'status',
              header: 'Status',
              render: (r) => <span className="text-xs text-zinc-700 dark:text-[#a1a1aa]">{r.status}</span>,
            },
            {
              key: 'blockedBy',
              header: 'Blocked by',
              render: (r) => <span className="font-mono text-[10px] text-zinc-700 dark:text-[#a1a1aa]">{r.blockedBy}</span>,
            },
          ]}
          empty={<p className="text-xs text-zinc-700 dark:text-[#71717a]">No risks indexed.</p>}
        />
      </AdminCard>
    </div>
  );
    ...
    <div className="mb-6">
      <AdminCard title="Renewal pressure">
        <div className="mb-4 flex flex-wrap items-baseline gap-4">
          ...
          <p className="font-mono text-xs text-zinc-700 dark:text-[#71717a]">{renewals.length} tracked</p>
        </div>
        <DataTable
          ...
          columns={[
            ...
            { key: 'subtitle', header: 'Subject', render: (r) => <span className="text-xs text-zinc-700 dark:text-[#a1a1aa]">{r.subtitle}</span> },
            {
              key: 'due',
              header: 'Next due',
          ...
          empty={<p className="text-xs text-zinc-700 dark:text-[#71717a]">No renewals with dates.</p>}
        />
      </AdminCard>
    </div>
  );
  ...
  return (
    <div className="mb-6">
      <AdminCard
        ...
        action={<span className="font-mono text-[10px] uppercase tracking-[0.15em] text-zinc-700 dark:text-[#71717a]">{total} pending</span>}
      >
        ...
        <div className="mb-3">
          <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-700 dark:text-[#71717a]">By cluster</p>
          <DataTable
            rows={clusters}
            columns={[
        ...
        <p className="mt-3 rounded-lg border border-dashed border-zinc-200 dark:border-[#27272a] bg-white dark:bg-[#0a0a0b] px-3 py-2 text-[11px] text-zinc-700 dark:text-[#71717a]">
...
function PortfolioTile({ label, value, tone }: { label: string; value: number; tone: Tone }) {
  ...
  return (
    <div className={`rounded-2xl border p-4 ${ring}`}>
      <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-700 dark:text-[#71717a]">{label}</p>
