...
export default function DecisionsClient({
  ...
  return (
    <div>
      ...
      <div className="mb-4 rounded-2xl border border-[#27272a] bg-[#111113] p-4">
        <p className="text-[10px] uppercase tracking-wider text-[#52525b] mb-2">Summary</p>
            ...
            <button
              ...
              className={`text-[10px] font-mono uppercase tracking-[0.15em] px-3 py-1.5 rounded-full border transition-colors ${
                active
                  ...
                  : 'border-[#27272a] text-[#a1a1aa] hover:bg-[#1c1c1e]'
              }`}
            >
              {f.label}
            </button>
      ...
      {!hasAnyVisible && (
        <div className="rounded-2xl border border-dashed border-[#27272a] bg-[#0a0a0b] p-8 text-center mb-6">
          <p className="text-sm text-[#a1a1aa]">No decisions match this filter.</p>
          <p className="mt-1 text-xs text-[#52525b]">Switch to &ldquo;All&rdquo; to see every item.</p>
        </div>
      )}
    ...
    <div className="rounded-2xl border border-[#27272a] bg-[#111113] p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
        ...
        <div className="space-y-2">
          ...
          <Row
            label="Action"
            value={<code className="font-mono text-[10px] text-[#a1a1aa] break-all">{d.action}</code>}
          />
          <Row
            label="Blocked by"
            value={
      ...
      <div className="mt-4 pt-3 border-t border-[#1c1c1e]">
        <p className="text-[10px] uppercase tracking-wider text-[#52525b] mb-2">Your call</p>
        ...
        <textarea
          ...
          className="mt-3 w-full rounded-lg border border-[#27272a] bg-[#0a0a0b] px-3 py-2 text-xs text-[#e4e4e7] placeholder:text-[#52525b] focus:outline-none focus:border-[#3f3f46] resize-none"
        />
