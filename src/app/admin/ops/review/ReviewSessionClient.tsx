      ...
      <div className="space-y-4">
        <div>
          <label
            ...
            className="block text-[10px] uppercase tracking-wider text-zinc-600 dark:text-[#52525b] mb-1.5"
          >
            Reviewer name
          </label>
          <input
            ...
            maxLength={120}
            className="w-full rounded-lg border border-zinc-200 dark:border-[#27272a] bg-white dark:bg-[#0a0a0b] px-3 py-2 text-xs text-zinc-800 dark:text-[#e4e4e7] placeholder:text-zinc-600 dark:text-[#52525b] focus:outline-none focus:border-[#3f3f46]"
          />
        </div>

        <div className="flex items-center justify-between gap-3 flex-wrap">
          <p className="font-mono text-[11px] text-zinc-700 dark:text-[#71717a]">
            Started at:{' '}
            <span className="text-zinc-700 dark:text-[#a1a1aa]">
              {hydrated
          ...
          <button
            ...
            className="text-[10px] font-mono uppercase tracking-[0.15em] px-3 py-1.5 rounded-full border border-zinc-200 dark:border-[#27272a] text-zinc-700 dark:text-[#a1a1aa] hover:bg-zinc-100 dark:bg-[#1c1c1e] transition-colors"
          >
            Reset session
          </button>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-200 dark:border-[#27272a] bg-white dark:bg-[#0a0a0b] p-4">
          <p className="text-[10px] uppercase tracking-wider text-zinc-600 dark:text-[#52525b] mb-2">
            Session stats
          </p>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-zinc-200 dark:border-[#27272a] bg-white dark:bg-[#0a0a0b] px-3 py-2 text-xs text-zinc-800 dark:text-[#e4e4e7] placeholder:text-zinc-600 dark:text-[#52525b] focus:outline-none focus:border-[#3f3f46] resize-none"
          />
          <p className="mt-1 text-[10px] text-zinc-600 dark:text-[#52525b] text-right">
        ...
        <p className="text-[11px] text-zinc-700 dark:text-[#71717a] leading-relaxed">
          Local browser only — not synced until <code className="font-mono text-[10px] text-zinc-700 dark:text-[#a1a1aa]">DATABASE_URL</code> is connected.
        </p>
      </div>
    </AdminCard>
  );
...
function StatTile({ label, value }: { label: string; value: number }) {
  return (
    <div className="rounded-lg border border-zinc-200 dark:border-[#1c1c1e] bg-white dark:bg-[#111113] px-3 py-2">
      ...
      <p className="mt-0.5 text-[10px] uppercase tracking-wider text-zinc-700 dark:text-[#71717a]">
        {label}
      </p>
    </div>
  );
